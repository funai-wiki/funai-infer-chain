...
pub fn handle_contract_call_special_cases(
    ...
    if *contract_id == boot_code_id(POX_1_NAME, global_context.mainnet) {
        ...
        if !pox_2::is_read_only(function_name) && global_context.epoch_id >= FunaiEpochId::Epoch22
        {
        ...
        if !pox_3::is_read_only(function_name) && global_context.epoch_id >= FunaiEpochId::Epoch25
        {
