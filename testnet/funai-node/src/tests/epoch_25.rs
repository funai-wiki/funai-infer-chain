...
use crate::tests::{make_funai_transfer_mblock_only, to_addr};
...
fn microblocks_disabled() {
    ...
    let spender_1_sk = FunaiPrivateKey::new();
    ...
    let tx = make_funai_transfer_mblock_only(&spender_1_sk, 0, 500, &spender_2_addr, 500);
    ...
    let tx = make_funai_transfer_mblock_only(&spender_1_sk, 1, 500, &spender_2_addr, 500);
    submit_tx(&http_origin, &tx);
