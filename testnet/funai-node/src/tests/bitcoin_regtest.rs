...
fn bitcoind_integration(segwit_flag: bool) {
    ...
    // In this serie of tests, the callback is fired post-burnchain-sync, pre-funai-sync
    run_loop
        .callbacks
    ...
    // In this serie of tests, the callback is fired post-burnchain-sync, post-funai-sync
                ...
                0 => {
                    ...
                    assert!(
                        chain_tip.block.header.block_hash()
                            == burnchain_tip.block_snapshot.winning_funai_block_hash
                    );
                }
                1 => {
