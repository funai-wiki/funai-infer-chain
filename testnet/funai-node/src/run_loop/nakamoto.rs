...
use crate::nakamoto_node::{self, FunaiNode, BLOCK_PROCESSOR_STACK_SIZE, RELAYER_MAX_BUFFER};
use crate::node::{
...
impl RunLoop {
    ...
    fn boot_chainstate(&mut self, burnchain_config: &Burnchain) -> FunaiChainState {
