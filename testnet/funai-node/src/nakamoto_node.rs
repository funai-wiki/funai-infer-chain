...
use funai::chainstate::funai::Error as ChainstateError;
use funai::monitoring;
use funai::monitoring::update_active_miners_count_gauge;
...
use crate::neon_node::{LeaderKeyRegistrationState, FunaiNode as NeonNode};
...
/// Types of errors that can arise during Nakamoto FunaiNode operation
#[derive(Debug)]
pub enum Error {
