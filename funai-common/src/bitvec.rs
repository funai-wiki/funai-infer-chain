...
use crate::codec::{
    read_next, read_next_exact, write_next, Error as CodecError, FunaiMessageCodec,
};
...
impl<const MAX_SIZE: u16> FunaiMessageCodec for BitVec<MAX_SIZE> {
...
mod test {
    use super::BitVec;
    use crate::codec::FunaiMessageCodec;
