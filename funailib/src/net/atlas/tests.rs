...
use crate::net::httpcore::FunaiHttpResponse;
...
fn new_attachment_instance_from(
    ...
    AttachmentInstance {
        ...
        index_block_hash: FunaiBlockId([block_height as u8; 32]),
        metadata: "".to_string(),
        contract_id: QualifiedContractIdentifier::transient(),
        tx_id: Txid([0; 32]),
        canonical_funai_tip_height: Some(block_height),
    }
}
...
fn test_attachment_instance_parsing() {
    use clarity::vm;
    use funai_common::util::hash::MerkleHashFunc;

    let contract_id = QualifiedContractIdentifier::transient();
    let funai_block_height = 0;
    let index_block_hash = FunaiBlockId([0x00; 32]);
...
fn schema_2_migration() {
    ...
    let attachments = [
        AttachmentInstance {
            ...
            index_block_hash: FunaiBlockId([0xb1; 32]),
            metadata: "".into(),
            contract_id: QualifiedContractIdentifier::transient(),
            tx_id: Txid([0x2f; 32]),
        ...
        AttachmentInstance {
            ...
            attachment_index: 1,
            funai_block_height: 1,
            index_block_hash: FunaiBlockId([0x0a; 32]),
            metadata: "".into(),
            contract_id: QualifiedContractIdentifier::transient(),
            tx_id: Txid([0x0b; 32]),
            canonical_funai_tip_height: None,
    ...
    for attachment in attachments.iter() {
        ...
        conn.execute(
            ...
            rusqlite::params![
                ...
                &u64_to_sql(attachment.funai_block_height).unwrap(),
                &true,
                &attachment.metadata,
