...
use funai_common::util::hash::{hex_bytes, to_hex, Hash160, MerkleHashFunc};
...
impl AttachmentInstance {
    ...
    pub fn try_new_from_value(
        ...
        tx_id: Txid,
        canonical_funai_tip_height: Option<u64>,
                ...
                match (
                    ...
                    (
                        ...
                        let instance = AttachmentInstance {
                            ...
                            tx_id,
                            canonical_funai_tip_height: canonical_funai_tip_height,
                        };
