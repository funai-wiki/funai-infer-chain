...
pub struct WantedTenure {
    ...
    pub winning_block_id: FunaiBlockId,
...
pub struct TenureStartEnd {
    ...
    pub start_block_id: FunaiBlockId,
    /// Last block ID
    pub end_block_id: FunaiBlockId,
...
impl TenureStartEnd {
    pub fn new(
        tenure_id_consensus_hash: ConsensusHash,
        start_block_id: FunaiBlockId,
        end_block_id: FunaiBlockId,
    ...
    pub fn from_inventory(
        ...
        // parent tenure, the start-block ID for tenure i would be the FunaiBlockId for the
        // next-available tenure.  Its end-block ID would be the FunaiBlockId for the
