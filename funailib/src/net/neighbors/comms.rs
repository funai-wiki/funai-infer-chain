...
use crate::net::{
    ...
    FunaiMessage, FunaiMessageType, NUM_NEIGHBORS,
};
...
pub trait NeighborComms {
    ...
    ) -> Vec<(NeighborAddress, FunaiMessage)>;
    ...
    fn neighbor_handshake<NK: ToNeighborKey>(
        ...
        let msg = network
            .sign_for_neighbor(&nk, FunaiMessageType::Handshake(handshake_data))
            .map_err(|e| {
                info!(
    ...
    /// On success, consume the reply handle and return the FunaiMessage.
    ...
    ) -> Result<FunaiMessage, Result<ReplyHandleP2P, net_error>> {
...
impl NeighborCommsRequest {
    ...
    pub fn is_message_stale(msg: &FunaiMessage, burn_block_height: u64) -> bool {
