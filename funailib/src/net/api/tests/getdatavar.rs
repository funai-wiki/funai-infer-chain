...
fn test_try_parse_request() {
    ...
    let mut handler = getdatavar::RPCGetDataVarRequestHandler::new();
    ...
    assert_eq!(handler.varname, Some("test-var".into()));
...
fn test_try_make_response() {
    ...
    let request = FunaiHttpRequest::new_getdatavar(
        ...
        FunaiAddress::from_string("ST2DS4MSWSGJ3W9FBC6BVT0Y92S345HY8N3T6AV7R").unwrap(),
        "hello-world-unconfirmed".try_into().unwrap(),
        "bar-unconfirmed".try_into().unwrap(),
