...
fn test_try_parse_request() {
    ...
    .unwrap();
    let request = FunaiHttpRequest::new_get_funaidb_chunk(
        addr.into(),
    ...
    let mut handler = getfunaidbchunk::RPCGetFunaiDBChunkRequestHandler::new();
...
fn test_try_make_response() {
    ...
    let resp = response.decode_funaidb_chunk().unwrap();
