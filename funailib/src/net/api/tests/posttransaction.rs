...
fn test_try_parse_request() {
    ...
    let request = FunaiHttpRequest::new_post_transaction(addr.into(), tx_cc_signed.clone());
    ...
    let request = FunaiHttpRequest::new_post_transaction_with_attachment(
        addr.into(),
        tx_cc_signed.clone(),
        None,
    );
...
fn test_try_make_response() {
    ...
    let request =
        FunaiHttpRequest::new_post_transaction_with_attachment(addr.into(), bad_tx.clone(), None);
    requests.push(request);
