...
fn test_try_parse_request() {
    ...
    let request =
        FunaiHttpRequest::new_get_nakamoto_tenure(addr.into(), FunaiBlockId([0x11; 32]), None);
...
fn test_try_make_response() {
    ...
    let request =
        FunaiHttpRequest::new_get_nakamoto_tenure(addr.into(), nakamoto_chain_tip.clone(), None);
