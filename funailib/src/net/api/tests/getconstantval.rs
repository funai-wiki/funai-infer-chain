...
fn test_try_parse_request() {
    ...
    let request = FunaiHttpRequest::new_getconstantval(
        addr.into(),
        FunaiAddress::from_string("ST2DS4MSWSGJ3W9FBC6BVT0Y92S345HY8N3T6AV7R").unwrap(),
        "hello-world-unconfirmed".try_into().unwrap(),
        "test-const".try_into().unwrap(),
    ...
    let mut handler = getconstantval::RPCGetConstantValRequestHandler::new();
    ...
    assert!(handler.constname.is_none());
}
...
fn test_try_make_response() {
    ...
    let request = FunaiHttpRequest::new_getconstantval(
        ...
        FunaiAddress::from_string("ST2DS4MSWSGJ3W9FBC6BVT0Y92S345HY8N3T6AV7R").unwrap(),
        "hello-world-unconfirmed".try_into().unwrap(),
        "cst-unconfirmed".try_into().unwrap(),
