...
fn test_try_parse_request() {
    ...
    let request = FunaiHttpRequest::new_gettransaction_unconfirmed(addr.into(), Txid([0x11; 32]));
...
fn test_try_make_response() {
    ...
    // get mempool txn
    let request = FunaiHttpRequest::new_gettransaction_unconfirmed(
        addr.into(),
    ...
    // get neither
    let request = FunaiHttpRequest::new_gettransaction_unconfirmed(addr.into(), Txid([0x21; 32]));
    requests.push(request);
