...
use crate::net::httpcore::{
    request, HttpPreambleExtensions, RPCRequestHandler, FunaiHttpRequest, FunaiHttpResponse,
};
...
impl FunaiHttpRequest {
    ...
    pub fn new_gettransaction_unconfirmed(host: PeerHost, txid: Txid) -> FunaiHttpRequest {
