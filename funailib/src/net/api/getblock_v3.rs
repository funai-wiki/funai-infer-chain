...
impl NakamotoBlockStream {
    pub fn new(
        ...
        let db_conn = FunaiChainState::open_nakamoto_staging_blocks(&staging_db_path, false)?;
        let rowid = db_conn
            .conn()
...
impl FunaiHttpRequest {
    pub fn new_get_nakamoto_block(host: PeerHost, block_id: FunaiBlockId) -> FunaiHttpRequest {
