...
use funai_common::util::{get_epoch_time_secs, log, sleep_ms};
...
use crate::net::{
    Error as net_error, MessageSequence, Preamble, ProtocolFamily, RelayData, FunaiHttp, FunaiP2P,
};
...
pub struct ConnectionOptions {
    ...
    pub max_funaidb_push_bandwidth: u64,
    ...
    pub disable_funaidb_get_chunks: bool,
...
impl std::default::Default for ConnectionOptions {
    fn default() -> ConnectionOptions {
        ConnectionOptions {
            ...
            max_funaidb_push_bandwidth: 0, // infinite upload bandwidth allowed
            ...
            disable_funaidb_get_chunks: false,
...
pub type ConnectionP2P = NetworkConnection<FunaiP2P>;
pub type ReplyHandleP2P = NetworkReplyHandle<FunaiP2P>;

pub type ConnectionHttp = NetworkConnection<FunaiHttp>;
pub type ReplyHandleHttp = NetworkReplyHandle<FunaiHttp>;
...
mod test {
    ...
    fn ping_factory(request_id: u32) -> FunaiMessage {
        ...
        let mut ping = FunaiMessage::new(
            ...
            FunaiMessageType::Ping(PingData { nonce: nonce }),
        );
    ...
    fn test_connection_ping_relay_producer_consumer() {
        ...
        let conn = ConnectionP2P::new(FunaiP2P::new(), &conn_opts, None);

        test_connection_relay_producer_consumer(FunaiP2P::new(), conn, ping_factory);
    }
    ...
    fn test_connection_ping_request_producer_consumer() {
        ...
        test_connection_request_producer_consumer(FunaiP2P::new(), conn, ping_factory);
    }
    ...
    fn connection_relay_send() {
        ...
        let mut conn = ConnectionP2P::new(FunaiP2P::new(), &conn_opts, None);
        ...
        assert_eq!(
            FunaiMessage::consensus_deserialize(&mut io::Cursor::new(
    ...
    fn connection_relay_send_recv() {
        ...
        let mut conn = ConnectionP2P::new(FunaiP2P::new(), &conn_opts, Some(neighbor.public_key));
    ...
    fn connection_send_recv() {
        with_timeout(100, || {
            ...
            let mut conn =
                ConnectionP2P::new(FunaiP2P::new(), &conn_opts, Some(neighbor.public_key));
            ...
            for i in 0..5 {
                let mut ping = FunaiMessage::new(
                    ...
                    12339 + i,
                    &BurnchainHeaderHash([0x22; 32]),
                    FunaiMessageType::Ping(PingData {
