...
use funai_common::util::hash::{to_hex, Sha256Sum};
...
/// Reference [SIP018](https://github.com/funaigov/sips/blob/main/sips/sip-018/sip-018-signed-structured-data.md) for more information.
...
pub mod pox4 {
    use super::{
        ...
        PrivateKey, Sha256Sum, FunaiPrivateKey, TupleData, Value,
    };
    ...
    mod tests {
        ...
        use super::*;
        use crate::chainstate::funai::address::pox_addr_b58_serialize;
        use crate::chainstate::funai::boot::contract_tests::ClarityTestSim;
        use crate::chainstate::funai::boot::{POX_4_CODE, POX_4_NAME};
        ...
        fn test_make_pox_4_message_hash() {
            ...
            let funai_addr = FunaiAddress::p2pkh(false, &pubkey);
            let pubkey = Secp256k1PublicKey::new();
            let principal = PrincipalData::from(funai_addr.clone());
            ...
            let other_pox_address = PoxAddress::from_legacy(
                ...
                FunaiAddress::p2pkh(false, &Secp256k1PublicKey::new()).bytes,
            );
            let result = call_get_signer_message_hash(
                &mut sim,
                &other_pox_address,
...
mod test {
    ...
    /// [SIP18 test vectors](https://github.com/funaigov/sips/blob/main/sips/sip-018/sip-018-signed-structured-data.md)
    #[test]
