...
use crate::chainstate::funai::TransactionPayload;
...
",
    ...
    (estimate_key, current_value, samples)
VALUES
    ('cc:2.1:SP000000000000000000002Q6VF78:pox-4.stack-stx:runtime', 0, '[0,0,0,0]');
",
    "
INSERT OR REPLACE INTO pessimistic_estimator
    (estimate_key, current_value, samples)
VALUES
    ('cc:2.1:SP000000000000000000002Q6VF78:pox-4.stack-stx:write-length', 0, '[0,0,0,0]');
",
    "
INSERT OR REPLACE INTO pessimistic_estimator
    (estimate_key, current_value, samples)
VALUES
    ('cc:2.1:SP000000000000000000002Q6VF78:pox-4.stack-stx:write-count', 0, '[0,0,0,0]');
",
    "
INSERT OR REPLACE INTO pessimistic_estimator
    (estimate_key, current_value, samples)
VALUES
    ('cc:2.1:SP000000000000000000002Q6VF78:pox-4.stack-stx:read-length', 0, '[0,0,0,0]');
",
    "
INSERT OR REPLACE INTO pessimistic_estimator
    (estimate_key, current_value, samples)
        ...
        let tx_descriptor = match tx {
            ...
            TransactionPayload::ContractCall(cc) => {
                ...
                let epoch_marker = match evaluated_epoch {
                    ...
                    FunaiEpochId::Epoch2_05 => ":2.05",
                    FunaiEpochId::Epoch21 => ":2.1",
                    // reuse cost estimates in Epoch22
                    FunaiEpochId::Epoch22 => ":2.1",
                    // reuse cost estimates in Epoch23
                    FunaiEpochId::Epoch23 => ":2.1",
                    // reuse cost estimates in Epoch24
                    FunaiEpochId::Epoch24 => ":2.1",
                    // reuse cost estimates in Epoch25
                    FunaiEpochId::Epoch25 => ":2.1",
                    // reuse cost estimates in Epoch30
                    FunaiEpochId::Epoch30 => ":2.1",
                };
                format!(
                    "cc{}:{}:{}.{}",
            ...
            TransactionPayload::RegisterModel(..) => "register-model".to_string(),
        };
