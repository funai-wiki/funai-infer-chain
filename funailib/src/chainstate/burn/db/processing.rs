...
use funai_common::types::chainstate::{BurnchainHeaderHash, PoxId, SortitionId, TrieHash};
...
impl<'a> SortitionHandleTx<'a> {
    ...
    fn process_checked_block_ops(
        ...
        //         total_reward += FunaiChainState::get_coinbase_reward(
        //             burn_block_height,
    ...
    /// * do a cryptographic sortition to select the next Funai block
