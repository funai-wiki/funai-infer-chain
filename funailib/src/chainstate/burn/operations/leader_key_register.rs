...
use funai_common::types::chainstate::{
    BlockHeaderHash, BurnchainHeaderHash, FunaiAddress, TrieHash,
};
use funai_common::util::hash::{DoubleSha256, Hash160};
...
impl FunaiMessageCodec for LeaderKeyRegisterOp {
    /*
        Wire format:
