...
;; In the latter case, this map will be updated by the Funai
;; node itself, and transactions in the burnchain will take priority
;; over transactions in the Funai chain when processing this block.
...
(define-private (get-check-delegation (funai principal))
