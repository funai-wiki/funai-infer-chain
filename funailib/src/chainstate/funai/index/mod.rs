...
use funai_common::types::chainstate::{
    BlockHeaderHash, BurnchainHeaderHash, SortitionId, FunaiBlockId, TrieHash,
...
pub trait MarfTrieId:
    ...
    + funai_common::codec::FunaiMessageCodec
