...
use funai_common::util::slice_partialeq;
...
use crate::chainstate::funai::index::storage::{TrieFileStorage, TrieStorageConnection};
use crate::chainstate::funai::index::trie::Trie;
...
impl<T: MarfTrieId> FunaiMessageCodec for ProofTriePtr<T> {
...
impl<T: MarfTrieId> FunaiMessageCodec for ProofTrieNode<T> {
    fn consensus_serialize<W: Write>(&self, fd: &mut W) -> Result<(), codec_error> {
        self.id.consensus_serialize(fd)?;
...
impl<T: MarfTrieId> FunaiMessageCodec for TrieMerkleProofType<T> {
    fn consensus_serialize<W: Write>(&self, fd: &mut W) -> Result<(), codec_error> {
...
impl<T: MarfTrieId> FunaiMessageCodec for TrieMerkleProof<T> {
    fn consensus_serialize<W: Write>(&self, fd: &mut W) -> Result<(), codec_error> {
