...
use crate::chainstate::funai::index::storage::{NodeHashReader, TrieStorageConnection};
...
/// the tries are too big to fit into a single page, such as the Funai chainstate.
pub enum TrieFile {
    RAM(TrieFileRAM),
    Disk(TrieFileDisk),
}
