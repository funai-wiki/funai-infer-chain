...
use crate::chainstate::funai::db::{MinerRewardInfo, FunaiHeaderInfo};
use crate::chainstate::funai::index::Error as marf_error;
use crate::clarity_vm::clarity::Error as clarity_error;
use crate::net::Error as net_error;
use crate::util_lib::db::{DBConn, Error as db_error};
use crate::util_lib::strings::{InferLPString, FunaiString};
...
pub use funai_common::address::{
    C32_ADDRESS_VERSION_MAINNET_MULTISIG, C32_ADDRESS_VERSION_MAINNET_SINGLESIG,
    C32_ADDRESS_VERSION_TESTNET_MULTISIG, C32_ADDRESS_VERSION_TESTNET_SINGLESIG,
};
pub use funai_common::types::chainstate::{FunaiPrivateKey, FunaiPublicKey};
...
pub enum Error {
    InvalidFee,
    InvalidFunaiBlock(String),
    ExpectedTenureChange,
    InvalidFunaiMicroblock(String, BlockHeaderHash),
    // The bool is true if the invalid transaction was quietly ignored.
    InvalidFunaiTransaction(String, bool),
    ...
    FunaiTransactionSkipped(String),
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Error::InvalidFunaiBlock(ref s) => fmt::Display::fmt(s, f),
            Error::InvalidFunaiMicroblock(ref s, _) => fmt::Display::fmt(s, f),
            Error::InvalidFunaiTransaction(ref s, _) => fmt::Display::fmt(s, f),
            Error::PostConditionFailed(ref s) => fmt::Display::fmt(s, f),
            Error::NoSuchBlockError => write!(f, "No such Funai block"),
            ...
            Error::FunaiTransactionSkipped(ref r) => {
                write!(
                    f,
                    "Funai transaction skipped during assembly due to: {}",
                    r
                )
            }
            ...
            Error::InvalidChildOfNakomotoBlock => write!(
                f,
                "Funai Epoch 2-style block building off of Nakamoto block"
            ),
...
impl error::Error for Error {
    ...
    fn cause(&self) -> Option<&dyn error::Error> {
        match *self {
            ...
            Error::InvalidFunaiBlock(ref _s) => None,
            Error::InvalidFunaiMicroblock(ref _s, ref _h) => None,
            Error::InvalidFunaiTransaction(ref _s, _q) => None,
            ...
            Error::FunaiTransactionSkipped(ref _r) => None,
...
impl Error {
    ...
    fn name(&self) -> &'static str {
        match self {
            ...
            Error::InvalidFunaiBlock(ref _s) => "InvalidFunaiBlock",
            Error::InvalidFunaiMicroblock(ref _s, ref _h) => "InvalidFunaiMicroblock",
            Error::InvalidFunaiTransaction(ref _s, _q) => "InvalidFunaiTransaction",
            ...
            Error::FunaiTransactionSkipped(ref _r) => "FunaiTransactionSkipped",
...
impl Txid {
    /// A Funai transaction ID is a sha512/256 hash (not a double-sha256 hash)
    pub fn from_funai_tx(txdata: &[u8]) -> Txid {
    ...
    pub fn from_sighash_bytes(txdata: &[u8]) -> Txid {
        Txid::from_funai_tx(txdata)
    }
}

/// How a transaction may be appended to the Funai blockchain
#[repr(u8)]
#[derive(Debug, Clone, PartialEq, Copy, Serialize, Deserialize)]
pub enum TransactionAnchorMode {
    OnChainOnly = 1,  // must be included in a FunaiBlock
    OffChainOnly = 2, // must be included in a FunaiMicroBlock
    Any = 3,          // either
}
...
impl TransactionAuthField {
    ...
    pub fn as_public_key(&self) -> Option<FunaiPublicKey> {
        match *self {
    ...
    // TODO: enforce u8; 32
    pub fn get_public_key(&self, sighash_bytes: &[u8]) -> Result<FunaiPublicKey, net_error> {
        match *self {
            TransactionAuthField::PublicKey(ref pubk) => Ok(pubk.clone()),
            TransactionAuthField::Signature(ref key_fmt, ref sig) => {
                let mut pubk = FunaiPublicKey::recover_to_pubkey(sighash_bytes, sig)
...
/// a transaction's execution against a Funai address.
...
pub struct TokenTransferMemo(pub [u8; 34]); // same length as it is in funai v1
...
/// A transaction from Funais to signal new mining tenure
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct TenureChangePayload {
    ...
    /// The FunaiBlockId of the last block from the previous tenure
    pub previous_tenure_end: FunaiBlockId,
...
impl TenureChangePayload {
    pub fn extend(
        ...
        last_tenure_block_id: FunaiBlockId,
...
pub enum TransactionPayload {
    ...
    Infer(PrincipalData, u64, InferLPString, InferLPString, PrincipalData), // user, amount, userInput, context, node_principal
...
impl TransactionPayload {
    pub fn name(&self) -> &'static str {
        match self {
            ...
            TransactionPayload::RegisterModel(..) => "RegisterModel",
        }
    }
}
...
pub struct AssetInfo {
    pub contract_address: FunaiAddress,
    pub contract_name: ContractName,
...
pub enum PostConditionPrincipal {
    Origin,
    Standard(FunaiAddress),
    Contract(FunaiAddress, ContractName),
}
...
#[derive(Debug, Clone, PartialEq)]
pub struct FunaiTransactionSigner {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct FunaiMicroblock {
    pub header: FunaiMicroblockHeader,
    pub txs: Vec<FunaiTransaction>,
}

/// The header for an on-chain-anchored Funai block
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub struct FunaiBlockHeader {
    pub version: u8,
    pub total_work: FunaiWorkScore, // NOTE: this is the work done on the chain tip this block builds on (i.e. take this from the parent)
    pub proof: VRFProof,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct FunaiMicroblockHeader {
    pub version: u8,
    pub sequence: u16,
...
#[derive(Clone)]
pub struct FunaiBlockBuilder {
    pub chain_tip: FunaiHeaderInfo,
    pub header: FunaiBlockHeader,
    pub txs: Vec<FunaiTransaction>,
    pub micro_txs: Vec<FunaiTransaction>,
    pub total_anchored_fees: u64,
    pub total_confirmed_streamed_fees: u64,
    pub total_streamed_fees: u64,
    anchored_done: bool,
    bytes_so_far: u64,
    prev_microblock_header: FunaiMicroblockHeader,
    miner_privkey: FunaiPrivateKey,
...
pub mod test {
    ...
    use super::*;
    use crate::chainstate::funai::{FunaiPublicKey as PubKey, *};
    use crate::core::*;
    ...
    pub fn codec_all_transactions(
        ...
        let mblock_header_1 = FunaiMicroblockHeader {
            version: 0x12,
            sequence: 0x34,
        ...
        let mblock_header_2 = FunaiMicroblockHeader {
            version: 0x12,
            sequence: 0x34,
            prev_block: EMPTY_MICROBLOCK_PARENT_HASH.clone(),
    ...
    pub fn make_codec_test_block(num_txs: usize) -> FunaiBlock {
        let proof_bytes = hex_bytes("9275df67a68c8745c0ff97b48201ee6db447f7c93b23ae24cdc2400f52fdb08a1a6ac7ec71bf9c9c76e96ee4675ebff60625af28718501047bfd87b810c2d2139b73c23bd69de66360953a642c2a330a").unwrap();
        let proof = VRFProof::from_bytes(&proof_bytes[..].to_vec()).unwrap();
    ...
    pub fn make_codec_test_microblock(num_txs: usize) -> FunaiMicroblock {
        let privk = FunaiPrivateKey::from_hex(
            "6d430bb91222408e7706c9001cfaeb91b08c2be6d5ac95779ab52c6b431950e001",
        )
        .unwrap();
        ...
        let mut header = FunaiMicroblockHeader {
            version: 6,
            sequence: 1,
