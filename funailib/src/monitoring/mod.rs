...
use funai_common::util::uint::{Uint256, Uint512};
...
pub fn instrument_http_request_handler<F, R>(
    ...
    mut req: FunaiHttpRequest,
    handler: F,
) -> Result<R, net_error>
where
    F: FnOnce(&mut ConversationHttp, FunaiHttpRequest) -> Result<R, net_error>,
{
    #[cfg(feature = "monitoring_prom")]
...
#[allow(unused_variables)]
pub fn update_funai_tip_height(value: i64) {
    #[cfg(feature = "monitoring_prom")]
