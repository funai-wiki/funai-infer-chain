...
use funai_common::deps_common::bitcoin::blockdata::opcodes::{All as btc_opcodes, Class};
use funai_common::deps_common::bitcoin::blockdata::script::{Builder, Instruction, Script};
...
/// All of the parsing code in this implementation is for use in Funai 2.05 or earlier.
/// In Funai 2.1 and later, we don't care about the scriptSig at all.
/// But because Funai 2.05 and earlier will only accept transactions with recognized scriptSigs
...
fn to_txid(txin: &BtcTxIn) -> (Txid, u32) {
    // bitcoin-rs library (which funai_common::deps_common::bitcoin is based on)
...
mod tests {
    ...
    use funai_common::deps_common::bitcoin::network::serialize::deserialize as bitcoinlib_deserialize;
