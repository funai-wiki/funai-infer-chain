...
use funai_common::deps_common::bitcoin::blockdata::constants::genesis_block;
use funai_common::deps_common::bitcoin::network::constants::Network;
...
mod test {
    ...
    fn test_witness_size() {
        ...
        use funai_common::deps_common::bitcoin::blockdata::script::Script;
        use funai_common::deps_common::bitcoin::blockdata::transaction::{OutPoint, TxIn, TxOut};
