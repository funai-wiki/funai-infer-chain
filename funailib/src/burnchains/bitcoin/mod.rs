...
use funai_common::deps_common::bitcoin::network::serialize::Error as btc_serialize_error;
use funai_common::types::chainstate::BurnchainHeaderHash;
use funai_common::util::HexError as btc_hex_error;
...
pub type PeerMessage = funai_common::deps_common::bitcoin::network::message::NetworkMessage;
