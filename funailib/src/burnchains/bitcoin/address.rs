...
use funai_common::address::b58 as base58;
use funai_common::address::c32::c32_address;
use funai_common::deps_common::bech32;
use funai_common::deps_common::bech32::{u5, FromBase32, ToBase32};
...
/// Convert bitcoin address byte to funai address byte.
...
/// Convert funai address byte to bitcoin address byte
