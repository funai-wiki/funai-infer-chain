...
use funai_common::deps_common::bitcoin::network::message::NetworkMessage;
use funai_common::deps_common::bitcoin::network::serialize::{
...
use crate::core::{
    FunaiEpoch, FunaiEpochExtension, STACKS_EPOCHS_MAINNET, STACKS_EPOCHS_REGTEST,
    STACKS_EPOCHS_TESTNET,
};
use crate::util_lib::db::Error as DBError;

pub const USER_AGENT: &'static str = "Funai/2.1";

pub const BITCOIN_MAINNET: u32 = 0x34FE12AC;
...
/// was specified.
pub fn get_bitcoin_funai_epochs(network_id: BitcoinNetworkType) -> Vec<FunaiEpoch> {
    match network_id {
...
impl BurnchainIndexer for BitcoinIndexer {
    ...
    /// Get a vector of the funai epochs. This notion of epochs is dependent on the burn block height.
    /// Valid epochs include funai 1.0, funai 2.0, funai 2.05, and so on.
    ///
    /// Choose according to:
    ...
    fn get_funai_epochs(&self) -> Vec<FunaiEpoch> {
        FunaiEpoch::get_epochs(self.runtime.network_id, self.config.epochs.as_ref())
    }
