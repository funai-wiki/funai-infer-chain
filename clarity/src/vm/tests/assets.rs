...
#[apply(test_epochs)]
fn test_native_stx_ops(epoch: FunaiEpochId, mut env_factory: TopLevelMemoryEnvironmentGenerator) {
...
#[apply(test_epochs)]
fn test_total_supply(epoch: FunaiEpochId, mut env_factory: TopLevelMemoryEnvironmentGenerator) {
    let mut owned_env = env_factory.get_env(epoch);
