...
use rstest::rstest;
use funai_common::types::chainstate::BlockHeaderHash;
...
#[apply(test_epochs)]
fn test_contract_caller(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
...
#[apply(test_epochs)]
fn test_tx_sponsor(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_simple_naming_system(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_simple_contract_call(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_aborts(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_factorial_contract(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_as_max_len(epoch: FunaiEpochId, mut tl_env_factory: TopLevelMemoryEnvironmentGenerator) {
    let mut owned_env = tl_env_factory.get_env(epoch);
