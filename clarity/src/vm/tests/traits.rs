...
#[apply(test_epochs)]
fn test_pass_trait_to_subtrait(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
...
#[apply(test_epochs)]
fn test_embedded_trait(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    if epoch < FunaiEpochId::Epoch21 {
        return;
    }
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_let_trait(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    if epoch < FunaiEpochId::Epoch21 {
        return;
    }
    let mut owned_env = env_factory.get_env(epoch);
...
#[apply(test_epochs)]
fn test_let3_trait(epoch: FunaiEpochId, mut env_factory: MemoryEnvironmentGenerator) {
    if epoch < FunaiEpochId::Epoch21 {
        return;
    }
    let mut owned_env = env_factory.get_env(epoch);
