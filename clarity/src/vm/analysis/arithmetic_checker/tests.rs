...
fn check_good(contract: &str, version: ClarityVersion, epoch: FunaiEpochId) {
...
fn test_bad_defines(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let tests = [
...
fn test_variables_fail_arithmetic_check_clarity1() {
    ...
    for (contract, result) in tests.iter() {
        assert_eq!(
            arithmetic_check(contract, ClarityVersion::Clarity1, FunaiEpochId::Epoch2_05),
            result.clone(),
            "Check contract:\n {}",
            contract
        );
        assert_eq!(
            arithmetic_check(contract, ClarityVersion::Clarity1, FunaiEpochId::Epoch21),
            result.clone(),
            "Check contract:\n {}",
            contract
        );
    ...
    for contract in tests.iter() {
        check_good(contract, ClarityVersion::Clarity1, FunaiEpochId::Epoch2_05);
        check_good(contract, ClarityVersion::Clarity1, FunaiEpochId::Epoch21);
    }
}
...
fn test_variables_fail_arithmetic_check_clarity2() {
    ...
    for (contract, result) in tests.iter() {
        assert_eq!(
            arithmetic_check(contract, ClarityVersion::Clarity2, FunaiEpochId::Epoch21),
            result.clone(),
            "Check contract:\n {}",
            contract
        );
...
fn test_functions_contract() {
    ...
    for contract in good_tests.iter() {
        check_good(contract, ClarityVersion::Clarity1, FunaiEpochId::Epoch2_05);
        check_good(contract, ClarityVersion::Clarity1, FunaiEpochId::Epoch21);
        check_good(contract, ClarityVersion::Clarity2, FunaiEpochId::Epoch21);
    }
}
