...
#[apply(test_clarity_versions)]
fn test_incomplete_impl_trait_1(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
...
#[apply(test_clarity_versions)]
fn test_incomplete_impl_trait_2(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))
            (get-2 (uint) (response uint uint))
            (get-3 (uint) (response uint uint))))";
...
#[apply(test_clarity_versions)]
fn test_impl_trait_arg_admission_1(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
...
#[apply(test_clarity_versions)]
fn test_impl_trait_arg_admission_2(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
...
#[apply(test_clarity_versions)]
fn test_impl_trait_arg_admission_3(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 ((list 5 uint)) (response uint uint))))";
    let impl_contract = "(impl-trait .defun.trait-1)
        (define-public (get-1 (x (list 5 uint))) (ok u1))";
...
#[apply(test_clarity_versions)]
fn test_complete_impl_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))
            (get-2 (uint) (response uint uint))
            (get-3 (uint) (response uint uint))))";
...
#[apply(test_clarity_versions)]
fn test_cycle_in_traits_1_contract(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let dispatching_contract_src = "(define-trait trait-1 (
...
#[apply(test_clarity_versions)]
fn test_cycle_in_traits_2_contracts(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
...
fn test_dynamic_dispatch_including_wrong_nested_trait(
    ...
    match err.err {
        ...
        CheckErrors::TypeError(TypeSignature::CallableType(_), TypeSignature::CallableType(_))
            if epoch >= FunaiEpochId::Epoch21 && version < ClarityVersion::Clarity2 => {}
...
#[apply(test_clarity_versions)]
fn test_bad_call_with_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))))";
...
#[apply(test_clarity_versions)]
fn test_good_call_with_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))))";
    let dispatching_contract = "(use-trait trait-1 .defun.trait-1)
        (define-public (wrapped-get-1 (contract <trait-1>))
...
#[apply(test_clarity_versions)]
fn test_good_call_2_with_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))))";
...
#[apply(test_clarity_versions)]
fn test_contract_of_good(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))))";
    let dispatching_contract = "(use-trait trait-2 .defun.trait-1)
        (define-public (wrapped-get-1 (contract <trait-2>))
...
#[apply(test_clarity_versions)]
fn test_contract_of_wrong_type(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract_defining_trait = "(define-trait trait-1 (
            (get-1 (uint) (response uint uint))))";
...
#[apply(test_clarity_versions)]
fn test_trait_contract_not_found(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
