...
fn type_check_helper_v1(exp: &str) -> TypeResult {
    mem_run_analysis(exp, ClarityVersion::Clarity1, FunaiEpochId::latest())
...
fn test_define_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let good = [
...
#[apply(test_clarity_versions)]
fn test_use_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let bad = [
...
#[apply(test_clarity_versions)]
fn test_impl_trait(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
...
#[apply(test_clarity_versions)]
fn test_destructuring_opts(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let good = [
        "(unwrap! (some 1) 2)",
        "(unwrap-err! (err 1) 2)",
        "(unwrap! (ok 3) 2)",
...
#[apply(test_clarity_versions)]
fn test_trait_reference_unknown(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let bad = [(
        "(+ 1 <kvstore>)",
...
#[apply(test_clarity_versions)]
fn test_eqs(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let good = [
...
#[apply(test_clarity_versions)]
fn test_response_inference(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let good = [
...
#[apply(test_clarity_versions)]
fn test_options(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let contract = "
...
#[apply(test_clarity_versions)]
fn test_trait_same_contract(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let good = ["(define-trait trait-foo ((foo () (response uint uint))))
        (define-public (call-foo (f <trait-foo>))
            (contract-call? f foo)
        )
...
#[apply(test_clarity_versions)]
fn test_list_arg(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    let good = [
