...
pub fn check_special_default_to(
    ...
    if let TypeSignature::OptionalType(input_type) = input {
        ...
        TypeSignature::least_supertype(&FunaiEpochId::Epoch21, &default, &contained_type)
...
fn check_special_match_resp(
    ...
    TypeSignature::least_supertype(&FunaiEpochId::Epoch21, &ok_branch_type, &err_branch_type)
