...
fn check_special_set_var(
    ...
    if !expected_value_type.admits_type(&FunaiEpochId::Epoch2_05, &value_type)? {
...
fn check_special_equals(
    ...
    for x_type in arg_types.into_iter() {
        ...
        arg_type = TypeSignature::least_supertype(&FunaiEpochId::Epoch2_05, &x_type, &arg_type)
...
fn check_special_if(
    ...
    TypeSignature::least_supertype(&FunaiEpochId::Epoch2_05, expr1, expr2)
