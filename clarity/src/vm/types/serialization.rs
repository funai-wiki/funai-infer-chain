...
use funai_common::codec::{Error as codec_error, FunaiMessageCodec};
...
const DESERIALIZATION_TYPE_CHECK_EPOCH: FunaiEpochId = FunaiEpochId::Epoch21;
...
impl FunaiMessageCodec for PrincipalData {
...
/// Note: the FunaiMessageCodec implementation for Clarity values *does not*
///       sanitize its serialization or deserialization.
impl FunaiMessageCodec for Value {
    fn consensus_serialize<W: Write>(&self, fd: &mut W) -> Result<(), codec_error> {
...
pub mod tests {
    ...
    fn test_lists(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    ...
    #[apply(test_clarity_versions)]
    fn test_opts(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    ...
    #[apply(test_clarity_versions)]
    fn test_resp(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    ...
    #[apply(test_clarity_versions)]
    fn test_buffs(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    ...
    #[apply(test_clarity_versions)]
    fn test_string_ascii(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    ...
    #[apply(test_clarity_versions)]
    fn test_string_utf8(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
    ...
    #[apply(test_clarity_versions)]
    fn test_sanitization(#[case] version: ClarityVersion, #[case] epoch: FunaiEpochId) {
