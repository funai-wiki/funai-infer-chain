...
impl<'a, 'hooks> OwnedEnvironment<'a, 'hooks> {
    ...
    pub fn new(database: ClarityDatabase<'a>, epoch: FunaiEpochId) -> OwnedEnvironment<'a, '_> {
        OwnedEnvironment {
    ...
    pub fn execute_in_env<F, A, E>(
        ...
        f: F,
    ) -> std::result::Result<(A, AssetMap, Vec<FunaiTransactionEvent>), E>
    where
    ...
    pub fn initialize_contract(
        ...
        sponsor: Option<PrincipalData>,
        ast_rules: ASTRules,
    ) -> Result<((), AssetMap, Vec<FunaiTransactionEvent>)> {
        self.execute_in_env(
    ...
    ) -> Result<(Value, AssetMap, Vec<FunaiTransactionEvent>)> {
...
impl<'a, 'b, 'hooks> Environment<'a, 'b, 'hooks> {
    ...
    pub fn epoch(&self) -> &FunaiEpochId {
        &self.global_context.epoch_id
    }
    ...
    pub fn push_to_event_batch(&mut self, event: FunaiTransactionEvent) {
    ...
    pub fn register_stx_transfer_event(
        ...
        let event = FunaiTransactionEvent::STXEvent(STXEventType::STXTransferEvent(event_data));
    ...
    pub fn register_stx_infer_event(
        ...
        let event = FunaiTransactionEvent::STXEvent(STXEventType::STXInferEvent(event_data));
    ...
    pub fn register_stx_burn_event(&mut self, sender: PrincipalData, amount: u128) -> Result<()> {
        ...
        let event = FunaiTransactionEvent::STXEvent(STXEventType::STXBurnEvent(event_data));
    ...
    pub fn register_nft_transfer_event(
        ...
        let event = FunaiTransactionEvent::NFTEvent(NFTEventType::NFTTransferEvent(event_data));
    ...
    pub fn register_nft_mint_event(
        ...
        let event = FunaiTransactionEvent::NFTEvent(NFTEventType::NFTMintEvent(event_data));
    ...
    pub fn register_nft_burn_event(
        ...
        let event = FunaiTransactionEvent::NFTEvent(NFTEventType::NFTBurnEvent(event_data));
    ...
    pub fn register_ft_transfer_event(
        ...
        let event = FunaiTransactionEvent::FTEvent(FTEventType::FTTransferEvent(event_data));
    ...
    pub fn register_ft_mint_event(
        ...
        let event = FunaiTransactionEvent::FTEvent(FTEventType::FTMintEvent(event_data));
    ...
    pub fn register_ft_burn_event(
        ...
        let event = FunaiTransactionEvent::FTEvent(FTEventType::FTBurnEvent(event_data));
...
impl ContractContext {
    ...
    /// canonicalized.
    pub fn canonicalize_types(&mut self, epoch: &FunaiEpochId) {
...
mod test {
    ...
    fn test_canonicalize_contract_context() {
        ...
        contract_context.canonicalize_types(&FunaiEpochId::Epoch21);
