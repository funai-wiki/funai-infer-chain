    ...
    ($Name:ident ($Epoch2Version:ident, $Epoch205Version:ident)) => {
        pub fn $Name(
            ...
            match env.epoch() {
                ...
                FunaiEpochId::Epoch20 => $Epoch2Version(args, env, context),
                FunaiEpochId::Epoch2_05 => $Epoch205Version(args, env, context),
                // Note: We reuse 2.05 for 2.1.
                FunaiEpochId::Epoch21 => $Epoch205Version(args, env, context),
                // Note: We reuse 2.05 for 2.2.
                FunaiEpochId::Epoch22 => $Epoch205Version(args, env, context),
                // Note: We reuse 2.05 for 2.3.
                FunaiEpochId::Epoch23 => $Epoch205Version(args, env, context),
                // Note: We reuse 2.05 for 2.4.
                FunaiEpochId::Epoch24 => $Epoch205Version(args, env, context),
                // Note: We reuse 2.05 for 2.5.
                FunaiEpochId::Epoch25 => $Epoch205Version(args, env, context),
                // Note: We reuse 2.05 for 3.0.
                FunaiEpochId::Epoch30 => $Epoch205Version(args, env, context),
            }
        }
    };
}
...
fn special_as_contract(
    ...
    if *env.epoch() >= FunaiEpochId::Epoch21 {
