...
use funai_common::util::secp256k1::{secp256k1_recover, secp256k1_verify, Secp256k1PublicKey};
...
use crate::vm::types::{
    BuffData, CharType, PrincipalData, ResponseData, SequenceData, FunaiAddressExtensions,
...
fn pubkey_to_address_v1(pub_key: Secp256k1PublicKey) -> Result<FunaiAddress> {
...
fn pubkey_to_address_v2(pub_key: Secp256k1PublicKey, is_mainnet: bool) -> Result<FunaiAddress> {
